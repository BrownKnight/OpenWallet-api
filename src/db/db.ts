import { createConnection, getConnection, Connection, Repository, getRepository, EntityTarget } from "typeorm";
...
class PostgresDB {
   ...
   */
  static getRepository<TEntity extends OWEntity>(entityClass: EntityTarget<TEntity>): Repository<TEntity> {
