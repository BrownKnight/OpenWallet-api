...
// import { MockUserLoginDAO } from "@test/integration/db/mock/MockUserLoginDAO";
// import { MockTestData } from "@test/integration/db/mock/MockTestData";
...
//     const validUserLogin = { ...MockTestData.instance.userLogins[0], password: "TESTPASSWORD" };
...
//     const service = new UserLoginService();
//     const invalidUserLogin = { ...MockTestData.instance.userLogins[0], password: "INVALID" };
...
//     expect(response.entities?.[0]).toEqual(MockTestData.instance.userLogins[0]);
//   });

//   it(`Can retrieve an user login by it's ID`, async () => {
//     const service = new UserLoginService();
//     const entity = MockTestData.instance.userLogins[0];
...
//     const service = new UserLoginService();
//     const entity = MockTestData.instance.generateUserLogin();
